...
public class HashMap<K, V> extends AbstractMap<K, V> implements Map<K, V>, Cloneable, Serializable {
    ...
    final class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public final boolean contains(Object o) {
            ...
            Map.Entry<?, ?> e = (Map.Entry<?, ?>) o;
            Object key = e.getKey();
            Node<K, V> candidate = HashMap.this.getNode(hash(key), key);
        ...
        public final boolean remove(Object o) {
            if (o instanceof Map.Entry) {
                ...
                return HashMap.this.removeNode(hash(key), key, value, true, true) != null;
            }
            return false;
        }
    ...
    public V computeIfAbsent(K key,
        ...
        TreeNode<K, V> t = null;
        Node<K, V> old = null;
        if (this.size > this.threshold || (tab = this.table) == null ||
                (n = tab.length) == 0) {
            n = (tab = this.resize()).length;
        }
    ...
    public V computeIfPresent(K key,
        ...
        V oldValue;
        int hash = hash(key);
        if ((e = this.getNode(hash, key)) != null &&
    ...
    final int capacity() {
        return (this.table != null) ? this.table.length :
                (this.threshold > 0) ? this.threshold :
                        DEFAULT_INITIAL_CAPACITY;
    }
    ...
    private void readObject(java.io.ObjectInputStream s)
        ...
        if (mappings < 0) {
            ...
            this.threshold = ((cap < MAXIMUM_CAPACITY && ft < MAXIMUM_CAPACITY) ?
                    (int) ft : Integer.MAX_VALUE);
    ...
    abstract class HashIterator {
        ...
        HashIterator() {
            ...
            this.index = 0;
            if (t != null && HashMap.this.size > 0) { // advance to first entry
                do {
        ...
        public final void remove() {
            ...
            this.current = null;
            K key = p.key;
            HashMap.this.removeNode(hash(key), key, null, false, false);
            this.expectedModCount = HashMap.this.modCount;
        }
    }
    ...
    static final class KeySpliterator<K, V>
        ...
        public void forEachRemaining(Consumer<? super K> action) {
            ...
            if (tab != null && tab.length >= hi &&
                    (i = this.index) >= 0 && (i < (this.index = hi) || this.current != null)) {
                Node<K, V> p = this.current;
                this.current = null;
                do {
                    if (p == null) {
