...
public class LinkedHashMap<K, V> extends HashMap<K, V> implements Map<K, V> {
    ...
    void afterNodeInsertion(boolean evict) { // possibly remove eldest
        ...
        if (evict && (first = this.head) != null && this.removeEldestEntry(first)) {
            K key = first.key;
            this.removeNode(hash(key), key, null, false, true);
        }
    }
    ...
    void internalWriteEntries(java.io.ObjectOutputStream s) throws IOException {
        for (LinkedHashMap.Entry<K, V> e = this.head; e != null; e = e.after) {
            s.writeObject(e.key);
    ...
    final class LinkedKeySet extends AbstractSet<K> {
        ...
        public final boolean remove(Object key) {
            return LinkedHashMap.this.removeNode(hash(key), key, null, false, true) != null;
        }
    ...
    final class LinkedEntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public final boolean contains(Object o) {
            ...
            Object key = e.getKey();
            Node<K, V> candidate = LinkedHashMap.this.getNode(hash(key), key);
        ...
        public final boolean remove(Object o) {
            if (o instanceof Map.Entry) {
                ...
                return LinkedHashMap.this.removeNode(hash(key), key, value, true, true) != null;
            }
            return false;
        }
    ...
    abstract class LinkedHashIterator {
        ...
        public final void remove() {
            ...
            this.current = null;
            K key = p.key;
            LinkedHashMap.this.removeNode(hash(key), key, null, false, false);
            this.expectedModCount = LinkedHashMap.this.modCount;
        }
    }
